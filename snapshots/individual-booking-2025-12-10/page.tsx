...
export default function Page() {
  ...
  function validateForm(requireRider: boolean = false): string | null {
    ...
    // Validate stops - any stop with address text must have valid coordinates
    for (let i = 0; i < stops.length; i++) {
      const stop = stops[i];
      if (stop.address && stop.address.trim().length > 0) {
        if (!stop.lat || !stop.lng) {
          return `Please select a valid address for Stop ${i + 1} from the suggestions`;
        }
      }
    }
  ...
  // Format return time for display (UK format: dd/mm/yyyy HH:mm)
    ...
    try {
      ...
      if (!route) {
        ...
        if (!res.ok) {
          ...
          setError(errorData.error || errorData.data?.error || "Could not calculate route");
          return;
        }

        const routeJson = await res.json();
        // API returns { ok: true, data: { geometry, distance, duration } }
        route = routeJson.data || routeJson;
        setRouteData(route);
      }
      ...
      <div className="px-4 py-4 sm:py-6 max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <section className="glow-card bg-[#1b1b1b] p-4 sm:p-5 border border-[#333]">
            ...
            <div className="lg:hidden">
              {(pickupCoords || dropoffCoords || stopCoords.length > 0) && (
                <section className="glow-card overflow-hidden border border-[#333]">
                  <MapPreview
                    pickup={pickupCoords}
                    stops={stopCoords}
            ...
            {/* ===== SECTION 3: When ===== */}
            <section id="when-section" className="glow-card bg-[#1b1b1b] p-4 sm:p-5 border border-[#333]">
              ...
              {!asap && (
                <div>
                  <label className="text-xs text-[#aaa] mb-1 block">Pickup Date & Time</label>
                  <DateTimeInput
                    value={pickupTime}
              ...
              {returnTrip && (
                <div className="mt-2">
                  ...
                  <DateTimeInput
                    ...
                    hasError={returnTrip && !returnTime}
                  />
            ...
            <section className="glow-card bg-[#1b1b1b] p-4 sm:p-5 border border-[#333]">
                ...
                <button
                  ...
                  className={`p-3 text-left ${
                    vehicleType === "standard"
                      ? "glow-card-selected border-[#ffd55c] bg-[#ffd55c]/10"
                      : "glow-card border border-[#333] hover:border-[#555]"
                  }`}
                >
              ...
              {vehicleType === "luxury" && (
                <div className="glow-row mt-2 p-2 bg-[#ffd55c]/10 border border-[#ffd55c]/20 text-xs text-[#ffd55c]">
            ...
            <section id="passenger-section" className="glow-card bg-[#1b1b1b] p-4 sm:p-5 border border-[#333]">
          ...
          <div className="space-y-2">
            <div>
              ...
              <input
                ...
                className={`glow-input w-full p-2 text-sm h-9 bg-[#111] border text-[#f5f5f5] placeholder-[#555] focus:outline-none ${
                  touchedFields.name && fieldErrors.name
                    ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/30 !shadow-[0_0_12px_rgba(239,68,68,0.2)]"
                    : "border-[#333] focus:border-[#d4af37] focus:ring-2 focus:ring-[#d4af37]/30"
                }`}
            ...
            <div>
              ...
              <input
                ...
                className="glow-input w-full p-2 text-sm h-9 bg-[#111] border border-[#333] text-[#f5f5f5] placeholder-[#555] focus:outline-none focus:border-[#d4af37] focus:ring-2 focus:ring-[#d4af37]/30"
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <div>
                ...
                <select
                  ...
                  className="glow-input w-full p-2 text-sm h-9 bg-[#111] border border-[#333] text-[#f5f5f5] focus:outline-none focus:border-[#d4af37] focus:ring-2 focus:ring-[#d4af37]/30"
                >
            ...
            {airportPickup && (
              <div className="mt-2">
                ...
                <textarea
                  ...
                  className="glow-input w-full p-2 text-sm bg-[#111] border border-[#333] text-[#f5f5f5] placeholder-[#555] focus:outline-none focus:border-[#d4af37] focus:ring-2 focus:ring-[#d4af37]/30 resize-none h-16"
            ...
            <section className="space-y-2 sm:space-y-3">
              <button
                ...
                disabled={isLoading}
                className="glow-card-selected w-full py-3 bg-[#ffd55c] text-black font-semibold hover:bg-[#ffcc33] transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 !border-[#ffd55c]"
                style={{ boxShadow: '0 0 18px rgba(255, 213, 92, 0.25), 0 4px 14px rgba(0, 0, 0, 0.8)' }}
              >
                {isLoading ? (
              ...
              <button
                ...
                disabled={isLoading}
                className="glow-card w-full py-3 border-2 border-[#ffd55c] text-[#ffd55c] font-semibold hover:bg-[#ffd55c]/10 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Book Your Ride
              </button>
            </section>
          ...
          <div className="hidden lg:block space-y-4 lg:sticky lg:top-20 lg:self-start">
            ...
            {fareResult && (
              <section className="glow-card-selected bg-[#1b1b1b] p-4 sm:p-5 animate-fade-up">
            ...
            {bookingResult && !bookingResult.error && (
              <section className="glow-card-success p-4 sm:p-5 bg-[#1a1a1a] animate-fade-up animate-success-pulse">
        ...
        <div className="lg:hidden space-y-3 sm:space-y-4 mt-4">
          ...
          {fareResult && (
            <section className="glow-card-selected bg-[#1b1b1b] p-4 animate-fade-up">
              <h2 className="text-[10px] uppercase tracking-widest text-[#ffd55c] font-semibold mb-3">
                {fareResult.isLuxury ? "Executive Estimate" : "Fare Estimate"}
              </h2>
          ...
          {bookingResult && !bookingResult.error && (
            <section className="glow-card-success p-4 bg-[#1a1a1a]">
              {bookingStatus !== "cancelled" ? (
                <>
                  <div className="flex items-center gap-2 mb-3">
        ...
        <section className="glow-card bg-[#1b1b1b] p-4 sm:p-5 border border-[#333] mt-6 sm:mt-8 max-w-xl">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="glow-input w-full p-2 text-sm h-9 bg-[#111] border border-[#333] text-[#f5f5f5] placeholder-[#555] focus:outline-none focus:border-[#d4af37] focus:ring-2 focus:ring-[#d4af37]/30 font-mono"
